<?php
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $q = $pdo->prepare($sql);
            $q->execute(array($phone,$type,$address_id,$transaction_id,$id));
            Database::disconnect();
            header("Location: transaction_addressIndex.php");
        }
    } else {
...
<body>
    ...
    <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row">
                        <h3>Update a Transaction Address</h3>
                    </div>

                    <form class="form-horizontal" action="transaction_addressUpdate.php?id=<?php echo $id?>" method="post">
